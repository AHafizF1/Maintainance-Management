          ...
          <div className="w-full max-w-md overflow-hidden rounded-2xl border border-border/20 bg-black/90 p-8 shadow-2xl backdrop-blur-sm">
            <div className="pb-6 text-center md:text-left">
              ...
              <form onSubmit={handleSubmit} className="mb-6 space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full rounded-lg bg-primary px-4 py-2.5 font-medium text-gray-900 transition-colors hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-50"
                  disabled={isLoading}
                >
